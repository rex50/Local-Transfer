...
import com.rex50.android.localtransfer.local.netty.udp.NettyUdpConnectionTask
            ...
            if (convertedData != null) {
                ...
                if (response != null) {
                    val responseConverter =
                        converterFactory.findPackageDataConverter(replyType, responseClass)
                            ...
                            if (connectionTask is NettyUdpConnectionTask) {
                                if (remoteAddress != null) {
                                    connectionTask.sendData(
                                        ...
                                        sendDataCallback = object :
                                            INettyConnectionTask.SendDataCallback {
