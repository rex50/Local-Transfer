...
import com.rex50.android.localtransfer.local.core.SimpleObservable
import com.rex50.android.localtransfer.local.core.SimpleStateable
...
import com.rex50.android.localtransfer.local.netty.TransferProtoConstant
import com.rex50.android.localtransfer.local.netty.extensions.ConnectionServerClientImpl
import com.rex50.android.localtransfer.local.netty.extensions.ConnectionServerImpl
import com.rex50.android.localtransfer.local.netty.extensions.IClientManager
import com.rex50.android.localtransfer.local.netty.extensions.IServer
import com.rex50.android.localtransfer.local.netty.extensions.requestSimplify
import com.rex50.android.localtransfer.local.netty.extensions.simplifyServer
import com.rex50.android.localtransfer.local.netty.extensions.withClient
import com.rex50.android.localtransfer.local.netty.extensions.withServer
import com.rex50.android.localtransfer.local.netty.tcp.NettyTcpClientConnectionTask
import com.rex50.android.localtransfer.local.netty.tcp.NettyTcpServerConnectionTask
import com.rex50.android.localtransfer.local.p2p.conn.model.P2pDataType
import com.rex50.android.localtransfer.local.p2p.conn.model.P2pHandshakeReq
import com.rex50.android.localtransfer.local.p2p.conn.model.P2pHandshakeResp
import com.rex50.android.localtransfer.local.netty.NettyConnectionObserver
...
class P2pConnection(
    ...
    override val state: AtomicReference<P2pConnectionState> =
